...
const en = {
  ...
  // Accessibility-only strings (screen readers / ARIA labels)
  sr_checking_site: 'Checking site…',
  aria_popup_nav: 'Popup navigation',
  aria_whitelist_list: 'Trusted sites list',
  aria_blocklist_list: 'Blocked sites list',
  aria_report_section: 'Report this scam',
  options_about_heading: 'About',
  ...
  check_generic_error: 'Something went wrong — try again.',
  ...
  options_domain_invalid: 'Please enter a valid domain (e.g. example.com).',
  /** {domain} replaced at render time */
  options_domain_duplicate: '{domain} is already in your trusted sites list.',
  options_saved: 'Saved ✓',
  ...
  options_pro_unreachable:
    'Could not reach the license server — your last status is kept.',
  options_checkout_unconfigured:
    'Checkout is not configured yet. See docs/stripe-setup.md.',
...
const fr = {
  ...
  // Accessibility-only strings (screen readers / ARIA labels)
  sr_checking_site: 'Vérification du site…',
  aria_popup_nav: 'Navigation de la fenêtre',
  aria_whitelist_list: 'Liste des sites de confiance',
  aria_blocklist_list: 'Liste des sites bloqués',
  aria_report_section: 'Signaler cette fraude',
  options_about_heading: 'À propos',
  ...
  check_generic_error: 'Une erreur est survenue — réessayez.',
  ...
  banner_official_site: 'Vous cherchez le vrai site? Visitez :',
  ...
  options_domain_invalid: 'Veuillez entrer un domaine valide (p. ex. exemple.com).',
  options_domain_duplicate: '{domain} figure déjà dans vos sites de confiance.',
  ...
  options_pro_unreachable:
    'Impossible de joindre le serveur de licences — votre dernier statut est conservé.',
  options_checkout_unconfigured:
    'Le paiement n’est pas encore configuré. Voir docs/stripe-setup.md.',
